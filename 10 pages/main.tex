...
Information about these elements is extracted via XPath.%\footnote{XPath: \url{www.w3.org/TR/xpath/}}.
...
from version control systems, like SVN%\footnote{SVN: svn.apache.org} 
or Git%\footnote{Git: git-scm.com} 
